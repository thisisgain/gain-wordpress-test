...
namespace GainTest\ACF\Blocks\Content;
...
class ContentWithImage extends Block implements BlockInterface
{
    ...
    {
        parent::__construct();
        add_action('acf/init', 'registerBlock');
     ...
     * @param $block
     */
    public static function renderBlck($block): void
    {
        $vars['block'] = $block;
